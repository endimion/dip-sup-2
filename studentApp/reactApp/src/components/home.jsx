      ...
      render(){
        ...
        let cookieConset = <CookiesProvider cookies={cookies}>
                            <CookieBannerUniversal
                              ...
                              link={ <p style={{textDecoration: 'none'}}>By continuing we assume your permission to deploy cookies, as detailed in our <a style={{fontWeight: 'bold', color:'white'}} href='https://docs.google.com/document/d/1JpXJIOfo8FodjI1MvEFVRxC846VIW2ySlTdTkQ_Ctb4/edit?usp=sharing' target='_blank'>privacy and cookies policy</a>.</p>}
                              buttonMessage='OK'
                              dismissOnScroll={false}
                              onAccept={() => {}}
